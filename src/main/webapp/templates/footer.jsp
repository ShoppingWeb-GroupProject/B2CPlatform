		...
		<div class="row">
			<div class="col-lg-3">
                    <div class="first-item">
                        <div class="logo">
                            <img src="assets/images/KIXADO-white.png" alt="hexashop ecommerce templatemo" width="150">
                        </div>
                        <!-- <ul>
			...
			<div class="col-lg-12" >
				<li><a
					href="https://line.me/R/ti/p/@375uqvrnhttps://line.me/R/ti/p/@375uqvrn"><i
						class="fa"><img alt="LINE" src="assets/images/line.png" width="50" height="50"></a></li>
			</div>
		</div>
	</div>
</footer>
